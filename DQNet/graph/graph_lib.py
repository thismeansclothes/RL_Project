...
class Graph_Lib(object):
    def __init__(self):
        ...
        # getters
        self.lib.get_node_embed.argtypes = [ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
        ...
        # coloring of batch
        self.lib.color_batch.argtypes = [ctypes.POINTER(ctypes.c_int), ctypes.c_int]
        self.lib.color_batch.restype = ctypes.c_int
    ...
    def get_node_embed(self):
        ...
        res = self.lib.get_node_embed(ctypes.byref(a), ctypes.byref(b))
        arr = []
    ...
    def get_graph_embed(self):
        ...
        res = self.lib.get_graph_embed(ctypes.byref(a))
